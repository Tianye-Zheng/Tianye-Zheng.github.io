...
$$![avatar](https://github.com/Tianye-Zheng/$$
$$Tianye-Zheng.github.io/blob/master/PostPictures/......)$$

还有一种方式，执行脚本 MyPicEncoding.py ，参数是若干个图片文件名，会生成图片的 base64 编码，在文本中使用下列命令添加图片，
